            ...
            <div class="flex gap-6">
                                ...
                                <div class="flex flex-col gap-1.5">
                                    <label class="flex items-center gap-2 cursor-pointer">
                                        <input type="radio" name="category" value=""
                                            {{ !request('category') ? 'checked' : '' }} class="accent-[#7D1A2E]"
                            ...
                            <div class="px-5 py-4">
                                <label class="flex items-center gap-2 cursor-pointer">
                                    <input type="checkbox" name="negotiable" value="1"
                                        {{ request('negotiable') ? 'checked' : '' }} class="accent-[#7D1A2E]"
                                        onchange="document.getElementById('filterForm').submit()">
                ...
                <div class="flex-1 min-w-0">
                        ...
                        <div class="flex items-center gap-2">
                            ...
                            <select onchange="window.location.href=this.value"
                                ...
                                @foreach ($sorts as $val => $label)
                                    <option
                                        value="{{ route('listings.search', array_merge($baseQuery, ['sort' => $val])) }}"
                    ...
                    @if ($listings->count())
                        ...
                        {{ $listings->links() }}
                    @else
                        <x-empty-state icon="ti-search-off" title="Tidak ada iklan ditemukan"
